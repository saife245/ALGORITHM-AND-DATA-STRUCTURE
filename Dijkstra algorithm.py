...
class Node(object):
    def __init__(self, name):
        ...
        self.minDistance = sys.maxsize #min distance is from starting node to where it goes

    def __cmp__(self, otherVertex): #cmp == comparator which push to heap 
...
class Algorithm(object):
    def csp(self, vertexList, startVertex):
...
algorithm = Algorithm()
algorithm.csp(vertexList, node1)
